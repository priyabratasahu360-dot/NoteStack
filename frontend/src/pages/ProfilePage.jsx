      ...
      <div className="flex flex-col gap-8 h-screen items-center w-full lg:max-w-4xl m-4">
        ...
        <div className="avatar relative">
          <div className="w-24 rounded-full">
            <img src={authUser?.profilePhoto} alt="profile" className="avatar bg-gray-400" />
          </div>
        ...
        <ul className="list w-full">
          <li className="list w-full opacity-70 flex gap-8">
            ...
            <label>
              Username
              <div className="input w-full">{authUser?.userName}</div> {/* user name */}
            </label>
            {/* email */}
            <label>
              Email
        ...
        {/* submit */}
        <button className="btn w-full bg-primary" onClick={handleSaveChanges}>Save Changes</button>
      </div>
    </div>
  );
};
